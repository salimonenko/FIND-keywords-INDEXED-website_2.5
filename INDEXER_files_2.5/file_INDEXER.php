...
// 6. Работаем с русскими предлогами (союзами и т.п.)
    ...
    if(is_readable($path_FILE_name_STRING)){ // Если ранее уже проводилось индексирование и был запасен индекс-номер последнего проиндексированного файла
        ...
        file_put_contents(PATH_FILE_NAMES_ERROR, 'Ошибка - '. date("d.m.Y - H:m:s") . PHP_EOL. 'Почему-то файл '. $path_FILE_name_STRING. ' недоступен для записи' , FILE_APPEND);
    }
...
// 7.1.1. Основной способ прерывания индексирования
